...
public class MapperTemplate {
	...
	public static String buildMapperContent(Table table, String modelPakageName) {
		...
		result.append(buildDeleteByExample(tableName, modelPakageName, modelName));
	...
	private static String buildDeleteByExample(String tableName, String modelPakageName, String modelName) {
		StringBuilder result = new StringBuilder();
		result.append(StringUtils.LINE).append(StringUtils.TAB);
		result.append("<delete id=\"deleteByExample\" parameterType=\""+modelPakageName+"."+modelName+"Example\" >");
		result.append(StringUtils.LINE).append(StringUtils.TAB).append(StringUtils.TAB);
