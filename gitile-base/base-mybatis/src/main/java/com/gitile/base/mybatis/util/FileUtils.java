package com.gitile.base.mybatis.util;
...
import com.gitile.base.mybatis.bean.TableForeign;
import com.gitile.base.mybatis.bean.TablePrimary;
...
public class FileUtils {
	 ...
	 * 生成配置文件
	 */
	public static void buildConfigFile(Map<String, Object> rootMap, String savePath, String fileName, Template template) {
	...
	public static Module parseFromXml(String filePath) {
		...
		for (int i = 0 ; i < elements.getLength(); i++){ 
			...
			table.setBean(element.getAttribute("bean"));
            ...
            for (int j = 0 ; j < column_items.getLength(); j++){
            	...
            	column.setProperty(item.getAttribute("property"));
