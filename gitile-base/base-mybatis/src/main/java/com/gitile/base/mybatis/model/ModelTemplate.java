...
import com.gitile.base.mybatis.bean.DataType;
...
public class ModelTemplate {
	...
	public static String buildCriterion(List<TableColumn> propertys) {
		...
		for (TableColumn property:propertys) {
			...
			String prop = StringUtils.dealLine(property.getProperty(), true);
			String propl = StringUtils.dealLine(property.getProperty(), false);
