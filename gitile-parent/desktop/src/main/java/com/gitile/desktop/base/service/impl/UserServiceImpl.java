...
public class UserServiceImpl implements UserService {
	...
	@Override
	public Page<UserDto> pageUsers(Page<UserDto> page) {
		page.setList(sysUserDao.pageListByCondition(page));
		page.setTotalCount(sysUserDao.pageCountByCondition(page));
		return page;
	}
